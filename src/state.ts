...
export let stateOfWords: Array<StateType> = [
    ...
    {enWord: 'orphan', rusWord: ''},
    {enWord: 'orphanage', rusWord: ''},
    {enWord: 'harebrained', rusWord: ''},
    {enWord: 'survey', rusWord: ''},
    {enWord: 'think it over', rusWord: ''},
    {enWord: 'to deserve', rusWord: ''},
    {enWord: 'slump', rusWord: ''},
    {enWord: 'wander', rusWord: ''},
    {enWord: 'trail', rusWord: ''},
    {enWord: 'prairie', rusWord: ''},
    {enWord: 'to keep over', rusWord: ''},
